...
public class PhotoDataFragment extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater,ViewGroup container, Bundle savedInstanceState) {
		...
		TextView tv;
			 ...
			 tv.setText(MainActivity.db.getOneFieldData(o.imageAbsolutePath, MainActivity.db.fieldPhotoName));
			 ...
			 tv.setTextColor(Color.rgb(75, 14, 14));
			 tv.setPadding(25, 6, 2, 2);
			 tv.setText(MainActivity.db.getOneFieldData(o.imageAbsolutePath, MainActivity.db.fieldLatitude));
			 ((LinearLayout)linear).addView(tv);
			 ...
			 tv.setTextColor(Color.rgb(75, 14, 14));
			 tv.setPadding(25, 6, 2, 2);
			 tv.setText(MainActivity.db.getOneFieldData(o.imageAbsolutePath, MainActivity.db.fieldLongitude));
			 ((LinearLayout)linear).addView(tv);
